...
const CORE_OBJECTS = [
  ...
  },
  {
    ...
    fields: [
      ...
      // ── Installation Cost Grid widget fields (moved from Installation) ──
      ...
      // JSON-encoded array of {key, label} (moved from Installation).
      { apiName: 'installProgressColumns', label: 'Install Progress Report Columns', type: 'LongTextArea' },
      // ── Master Contact Sheet widget fields ──
      { apiName: 'jobLocationDevelopment', label: 'Job Location — Development', type: 'Text' },
      { apiName: 'jobLocationSiteTrailerPhone', label: 'Job Location — Site Trailer Ph.', type: 'Phone' },
      { apiName: 'jobLocationAddress', label: 'Job Location — Address', type: 'Text' },
      { apiName: 'jobLocationCityStateZip', label: 'Job Location — City, State, Zip', type: 'Text' },
      { apiName: 'houseManagerName', label: 'House Manager — Name', type: 'Text' },
      { apiName: 'houseManagerPhone', label: 'House Manager — Phone', type: 'Phone' },
      { apiName: 'houseManagerMobile', label: 'House Manager — Mobile', type: 'Phone' },
      { apiName: 'houseManagerFax', label: 'House Manager — Fax', type: 'Phone' },
      { apiName: 'houseManagerEmail', label: 'House Manager — E-mail', type: 'Email' },
      { apiName: 'clientRepName', label: 'Client Representative — Name', type: 'Text' },
      { apiName: 'clientRepPhone', label: 'Client Representative — Phone', type: 'Phone' },
      { apiName: 'clientRepFax', label: 'Client Representative — Fax', type: 'Phone' },
      { apiName: 'clientRepMobile', label: 'Client Representative — Mobile', type: 'Phone' },
      { apiName: 'clientRepEmail', label: 'Client Representative — E-mail', type: 'Email' },
      { apiName: 'jobSuperintendentName', label: 'Job Superintendent — Name', type: 'Text' },
      { apiName: 'jobSuperintendentPhone', label: 'Job Superintendent — Phone', type: 'Phone' },
      { apiName: 'jobSuperintendentMobile', label: 'Job Superintendent — Mobile', type: 'Phone' },
      { apiName: 'jobSuperintendentFax', label: 'Job Superintendent — Fax', type: 'Phone' },
      { apiName: 'jobSuperintendentEmail', label: 'Job Superintendent — E-mail', type: 'Email' },
      { apiName: 'clientOwnerContractHolder', label: 'Client/Owner — Contract Holder?', type: 'Checkbox' },
      { apiName: 'clientOwnerName', label: 'Client/Owner — Name', type: 'Text' },
      { apiName: 'clientOwnerAddress', label: 'Client/Owner — Address', type: 'Text' },
      { apiName: 'clientOwnerPhone', label: 'Client/Owner — Phone', type: 'Phone' },
      { apiName: 'clientOwnerMobile', label: 'Client/Owner — Mobile', type: 'Phone' },
      { apiName: 'clientOwnerFax', label: 'Client/Owner — Fax', type: 'Phone' },
      { apiName: 'clientOwnerEmail', label: 'Client/Owner — E-mail', type: 'Email' },
      { apiName: 'clientOwnerAddress2', label: 'Client/Owner — 2nd Address', type: 'Text' },
      { apiName: 'clientOwnerOther', label: 'Client/Owner — Other', type: 'Text' },
      { apiName: 'contractorContractHolder', label: 'Contractor — Contract Holder?', type: 'Checkbox' },
      { apiName: 'contractorName', label: 'Contractor — Name', type: 'Text' },
      { apiName: 'contractorTitle', label: 'Contractor — Title', type: 'Text' },
      { apiName: 'contractorCompany', label: 'Contractor — Company', type: 'Text' },
      { apiName: 'contractorPhone', label: 'Contractor — Phone', type: 'Phone' },
      { apiName: 'contractorMobile', label: 'Contractor — Mobile', type: 'Phone' },
      { apiName: 'contractorFax', label: 'Contractor — Fax', type: 'Phone' },
      { apiName: 'contractorEmail', label: 'Contractor — E-mail', type: 'Email' },
      { apiName: 'contractorAddress', label: 'Contractor — Address', type: 'Text' },
      { apiName: 'architectName', label: 'Architect — Name', type: 'Text' },
      { apiName: 'architectTitle', label: 'Architect — Title', type: 'Text' },
      { apiName: 'architectCompany', label: 'Architect — Company', type: 'Text' },
      { apiName: 'architectPhone', label: 'Architect — Phone', type: 'Phone' },
      { apiName: 'architectMobile', label: 'Architect — Mobile', type: 'Phone' },
      { apiName: 'architectFax', label: 'Architect — Fax', type: 'Phone' },
      { apiName: 'architectEmail', label: 'Architect — E-mail', type: 'Email' },
      { apiName: 'architectAddress', label: 'Architect — Address', type: 'Text' },
      { apiName: 'architectOther', label: 'Architect — Other', type: 'Text' },
      { apiName: 'designerName', label: 'Designer — Name', type: 'Text' },
      { apiName: 'designerTitle', label: 'Designer — Title', type: 'Text' },
      { apiName: 'designerCompany', label: 'Designer — Company', type: 'Text' },
      { apiName: 'designerPhone', label: 'Designer — Phone', type: 'Phone' },
      { apiName: 'designerMobile', label: 'Designer — Mobile', type: 'Phone' },
      { apiName: 'designerFax', label: 'Designer — Fax', type: 'Phone' },
      { apiName: 'designerEmail', label: 'Designer — E-mail', type: 'Email' },
      { apiName: 'designerAddress', label: 'Designer — Address', type: 'Text' },
      { apiName: 'designerOther', label: 'Designer — Other', type: 'Text' },
    ],
  },
  {
    apiName: 'Service',
  ...
  },
  {
    ...
    description: 'Install Progress Report rows tracked against a Project',
    fields: [
  ...
  },
  {
    ...
    description: 'CAD Index List widget rows tracked against a Project — reportType partitions rows into 3 independent lists',
    fields: [
      ...
      { apiName: 'location', label: 'Location', type: 'Text' },
      // Report 1 — Pre-Installation Survey List
      ...
      // Report 2 — Installation Progress List / Report 3 — Final Adjustment Check List (shared)
