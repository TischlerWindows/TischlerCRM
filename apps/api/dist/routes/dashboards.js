...
export async function dashboardRoutes(app) {
    ...
    app.put('/dashboards/:id', async (request, reply) => {
        try {
            const userId = request.user?.id;
            if (!userId) {
                return reply.status(401).send({ error: 'Unauthorized' });
    ...
    app.get('/dashboards/:id/widgets', async (request, reply) => {
        try {
            const userId = request.user?.id;
            if (!userId) {
                return reply.status(401).send({ error: 'Unauthorized' });
    ...
    app.post('/dashboards/:id/widgets', async (request, reply) => {
        try {
            const userId = request.user?.id;
            if (!userId) {
                return reply.status(401).send({ error: 'Unauthorized' });
    ...
    app.put('/dashboards/:id/widgets/:widgetId', async (request, reply) => {
        try {
            const userId = request.user?.id;
            if (!userId) {
                return reply.status(401).send({ error: 'Unauthorized' });
    ...
    app.delete('/dashboards/:id/widgets/:widgetId', async (request, reply) => {
        try {
            const userId = request.user?.id;
            if (!userId) {
                return reply.status(401).send({ error: 'Unauthorized' });
