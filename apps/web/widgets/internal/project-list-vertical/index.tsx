...
import { Loader2, AlertCircle, Save, LayoutList, FileText } from 'lucide-react'
import type { WidgetProps } from '@/lib/widgets/types'
import { recordsService } from '@/lib/records-service'
import { generateProjectListPdf } from '../project-list/pdf'
  ...
  const handlePreviewPdf = async () => {
    ...
    try {
      const { blob } = await generateProjectListPdf({
        title: 'Project List Vertical Page',
        projectName,
        projectNumber,
        groups: GROUPS,
        values,
      ...
      if (previewWindow && !previewWindow.closed) {
        ...
        link.href = url
        link.download = 'Project_List_Vertical_Page.pdf'
        link.click()
      }
