...
export function Toolbar({
  ...
  return (
    <div className="flex items-center gap-2 px-3 py-2.5 bg-gray-50 border border-gray-200 rounded-lg flex-wrap">
      ...
      <div className="flex gap-1">
        <button onClick={onAddWeek} className="text-xs px-2 py-1 bg-green-600 text-white rounded hover:bg-green-700 transition-colors flex items-center gap-1">
          <Plus className="w-3 h-3" /> Week
        </button>
        <button onClick={onRemoveWeek} className="text-xs px-2 py-1 bg-red-500 text-white rounded hover:bg-red-600 transition-colors flex items-center gap-1">
          <Minus className="w-3 h-3" /> Week
        </button>
      </div>
      <div className="flex-1" />
      <button onClick={onManageTechnicians} className="text-xs px-2 py-1 bg-[#f0f1f9] text-brand-navy border border-blue-200 rounded hover:bg-blue-50 transition-colors flex items-center gap-1">
