        ...
        {activeEntry ? (
          <div className="space-y-2">
            ...
            <button
              ...
              disabled={busy}
              className="mx-auto flex h-[144px] w-full items-center justify-center gap-3 rounded-md bg-red-600 px-6 text-lg font-semibold text-white hover:bg-red-700 disabled:opacity-60 transition-colors"
            >
