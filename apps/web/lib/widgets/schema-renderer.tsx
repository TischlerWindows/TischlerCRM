  ...
  return (
    <div className="space-y-3">
      {schema.map((field, i) => {
        ...
        const base =
          'w-full rounded-lg border border-gray-200 bg-gray-50 py-1.5 px-2.5 text-xs text-brand-dark placeholder:text-gray-400 focus:border-brand-navy focus:ring-1 focus:ring-brand-navy/20 outline-none transition'
        ...
        return (
          <div key={field.key}>
            ...
            {field.type === 'textarea' && (
              <textarea
                className={`${base} resize-none h-16`}
                value={value as string}
                placeholder={field.placeholder}
                onChange={(e) => onChange(field.key, e.target.value)}
              />
            ...
            {field.type === 'merge-text' && (
              <div className="relative">
                ...
                <button
                  ...
                  onClick={() => {
                    /* TODO: open field picker popover */
                  }}
                >
                  {'{}'}
                </button>
            ...
            {field.type === 'select' && (
              <select className={base} value={value as string} onChange={(e) => onChange(field.key, e.target.value)}>
            ...
            {field.type === 'json' && (
              <textarea
                className={`${base} resize-none h-24 font-mono text-[11px]`}
