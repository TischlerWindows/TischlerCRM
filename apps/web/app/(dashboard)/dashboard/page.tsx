...
export default function DashboardPage() {
  ...
  return (
    ...
    <div className="flex flex-1 bg-gray-50 h-screen relative">
        ...
        {/* Sidebar */}
        <div
          className={`${isMobile ? 'fixed top-[88px] bottom-0 w-44 z-30' : 'relative w-64'} left-0 bg-white border-r border-gray-100 ${isMobile ? 'p-4' : 'p-6'} overflow-y-auto flex-shrink-0 transition-transform duration-200 ease-in-out ${isMobile ? (mobileSidebarOpen ? 'translate-x-0 shadow-xl' : '-translate-x-full') : 'translate-x-0'}`}
