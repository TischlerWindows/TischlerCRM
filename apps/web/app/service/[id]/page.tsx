...
function getLayoutForRecord(record: Service | null, object: any): PageLayout | null {
...
function renderFieldValue(object: any, record: Service, apiName: string, value: any, fieldDef?: FieldDef): React.ReactNode {
  if (!value) return '-';
                            ...
                            return (
                              ...
                              >
                                {rowFields.map((layoutField) => {
                                  ...
                                  const fieldDef = getFieldDef(serviceObject, layoutField.apiName);
                                  const value = service[layoutField.apiName] || service[layoutField.apiName.replace(/^[^_]+__/, '')];
                                  ...
                                  return (
                                    <div key={layoutField.apiName}>
                                      ...
                                      <dd className="mt-1 text-sm text-gray-900">
                                        {renderFieldValue(serviceObject, service, layoutField.apiName, value, fieldDef)}
                                      </dd>
                                    </div>
                                  );
                                })}
