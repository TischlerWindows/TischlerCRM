...
export default function SecuritySettingsPage() {
  ...
  return (
    <>
      <SettingsPageHeader icon={Lock} title="Security" subtitle="Login history and access monitoring" />
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full text-sm">
              <thead className="bg-[#fafafa]">
                <tr>
                  <th className="text-left text-[11px] font-semibold text-brand-gray uppercase tracking-[0.04em] px-6 py-3">Time</th>
                  <th className="text-left text-[11px] font-semibold text-brand-gray uppercase tracking-[0.04em] px-6 py-3">User</th>
                  <th className="text-left text-[11px] font-semibold text-brand-gray uppercase tracking-[0.04em] px-6 py-3">Email</th>
                  <th className="text-left text-[11px] font-semibold text-brand-gray uppercase tracking-[0.04em] px-6 py-3">Role</th>
                  <th className="text-left text-[11px] font-semibold text-brand-gray uppercase tracking-[0.04em] px-6 py-3">Account</th>
                  <th className="text-left text-[11px] font-semibold text-brand-gray uppercase tracking-[0.04em] px-6 py-3">IP</th>
                  <th className="text-left text-[11px] font-semibold text-brand-gray uppercase tracking-[0.04em] px-6 py-3">User Agent</th>
                </tr>
              </thead>
              <tbody>
                {events.map((event) => (
