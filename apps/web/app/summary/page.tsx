...
export default function SummaryPage() {
  ...
  const handleSaveSummary = async () => {
    ...
    const summaryToSave = { ...editingSummary, productTypeOptions: prunedPto, summaryType: 'tischler' as const };
                ...
                <div className="max-w-7xl mx-auto space-y-8">
                  <div className="bg-white border border-gray-200 rounded-lg shadow-sm">
                    <div className="bg-brand-red px-3 sm:px-6 py-3 sm:py-4 rounded-t-lg">
                      ...
                      <p className="text-sm font-bold text-white mt-0.5">Overview information pulled from the data entry sheet</p>
                    </div>
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg shadow-sm">
                    <div className="bg-brand-red px-3 sm:px-6 py-3 sm:py-4 rounded-t-lg">
                      ...
                      <p className="text-sm font-bold text-white mt-0.5">Product details for this project</p>
                    </div>
                    <div className="p-3 sm:p-6 space-y-5">
                      ...
                      return (
                        <div className="bg-white border border-gray-200 rounded-lg shadow-sm mt-6">
                          <div className="bg-brand-red px-3 sm:px-6 py-3 sm:py-4 rounded-t-lg flex items-center gap-3">
                            ...
                            {!locLabel && <p className="text-sm font-bold text-white">Aggregated from the data entry sheet</p>}
                          </div>
                    ...
                    return (
                      ...
                      <div className="bg-white border border-gray-200 rounded-lg shadow-sm mt-6">
                        <div className="bg-brand-red px-3 sm:px-6 py-3 sm:py-4 rounded-t-lg">
                          ...
                          <p className="text-sm font-bold text-white mt-0.5">Aggregated from the data entry sheet</p>
                        </div>
                        <div className="overflow-x-auto">
                          <table className="min-w-[1200px] md:min-w-[680px] text-xs sm:text-sm">
                            <thead>
                        ...
                        return (
                          <div className="bg-white border border-gray-200 rounded-lg shadow-sm mt-6">
                            <div className="bg-brand-red px-3 sm:px-6 py-3 sm:py-4 rounded-t-lg">
                              ...
                              <p className="text-sm font-bold text-white mt-0.5">Additional line items below the quote totals</p>
                            </div>
                            <div className="overflow-x-auto">
