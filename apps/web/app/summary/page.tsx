  ...
  return (
    <>
      ...
      <div className={`${isMobile ? 'fixed top-[88px] bottom-0 w-44 z-30' : 'relative w-64'} left-0 bg-white border-r border-gray-200 ${isMobile ? 'p-4' : 'p-6'} overflow-y-auto flex-shrink-0 transition-transform duration-200 ease-in-out ${isMobile ? (mobileSidebarOpen ? 'translate-x-0 shadow-xl' : '-translate-x-full') : 'translate-x-0'}`}>
        ...
        <div className="space-y-6" style={isLandscapeMobile ? { transform: 'scale(0.85)', transformOrigin: 'top left' } : undefined}>
            ...
            <div className="flex-1 overflow-y-auto p-3 sm:p-6 space-y-6">
                ...
                <div className="max-w-7xl mx-auto space-y-8">
                  <div className="bg-white border border-gray-200 rounded-lg shadow-sm">
                    <div className="bg-brand-red px-3 sm:px-6 py-3 sm:py-4 rounded-t-lg">
                      <h3 className="text-base font-semibold text-white uppercase">Project Summary</h3>
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg shadow-sm">
                    <div className="bg-brand-red px-3 sm:px-6 py-3 sm:py-4 rounded-t-lg">
                      <h3 className="text-base font-semibold text-white uppercase">Product Specifications</h3>
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg shadow-sm">
                    <div className="bg-brand-red px-3 sm:px-6 py-3 sm:py-4 rounded-t-lg">
                      <h3 className="text-base font-semibold text-white uppercase">Delivery Cost</h3>
                    </div>
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg shadow-sm">
                    <div className="bg-brand-red px-3 sm:px-6 py-3 sm:py-4 rounded-t-lg">
                      <h3 className="text-base font-semibold text-white uppercase">Tax Cost</h3>
                    </div>
                    <div className="p-3 sm:p-6">
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div>
                  ...
                  {(() => {
                    ...
                    return (
                      <div className="bg-white border border-gray-200 rounded-lg shadow-sm">
                        <div className="bg-brand-red px-3 sm:px-6 py-3 sm:py-4 rounded-t-lg">
                          <h3 className="text-base font-semibold text-white uppercase">Cost Analysis</h3>
                        </div>
                  ...
                  {(() => {
                    ...
                    return (
                      ...
                      <div className="bg-white border border-gray-200 rounded-lg shadow-sm mt-6">
                        <div className="bg-brand-red px-3 sm:px-6 py-3 sm:py-4 rounded-t-lg">
                          <h3 className="text-base font-semibold text-white uppercase">{editingSummary.hasMultipleLocations ? 'Grand Total — All Locations' : 'Quote Totals'}</h3>
                      ...
                      {(() => {
                        ...
                        return (
                          <div className="bg-white border border-gray-200 rounded-lg shadow-sm mt-6">
                            <div className="bg-brand-red px-3 sm:px-6 py-3 sm:py-4 rounded-t-lg">
                              <h3 className="text-base font-semibold text-white uppercase">Add-On Items</h3>
              ...
              <div className="border rounded-lg overflow-hidden print-section mt-4">
                <div className="bg-brand-red px-4 py-3 flex justify-between items-center">
                  <h3 className="text-base font-semibold text-white uppercase">Windows</h3>
              ...
              <div className="border rounded-lg overflow-hidden mt-6 print-section">
                <div className="bg-brand-red px-4 py-3 flex justify-between items-center">
                  <h3 className="text-base font-semibold text-white uppercase">Doors</h3>
                  <div className="flex items-center gap-4 print:hidden">
                    <button
                      onClick={() => setTusPositionLocked(v => !v)}
                      title={tusPositionLocked ? 'Unlock TuS-Position column' : 'Lock TuS-Position column'}
