                ...
                <div className="max-w-7xl mx-auto space-y-8">
                  ...
                  {(() => {
                    ...
                    const renderQuoteTotalsTable = (
                      ...
                      const inputCell = (cat: 'euroWindows'|'doubleHung'|'euroDoors', f: string) => {
                            ...
                            <table className="min-w-[680px] text-xs sm:text-sm">
                              ...
                              <tbody className="divide-y divide-gray-100">
                                <tr className="hover:bg-gray-50">
                                  ...
                                  <td className="px-4 py-3 text-right text-green-600 bg-green-50/30">{lEwCalc.final ? fmt(lEwCalc.final) : '—'}</td>
                                ...
                                <tr className="hover:bg-gray-50">
                                  ...
                                  <td className="px-4 py-3 text-right text-green-600 bg-green-50/30">{lEdCalc.final ? fmt(lEdCalc.final) : '—'}</td>
                                ...
                                <tr className="bg-gray-50 font-semibold border-t-2 border-gray-300">
                                  ...
                                  <td className="px-4 py-3 text-right text-blue-700 border-l-4 border-blue-300 bg-blue-50/60">{lGtCalc.full ? fmt(lGtCalc.full) : '—'}</td>
                                  <td className="px-4 py-3 text-right text-blue-700 bg-blue-50/60">{lGtCalc.disc ? fmt(lGtCalc.disc) : '—'}</td>
                                  <td className="px-4 py-3 text-right text-green-700 bg-green-50/60">{lGtCalc.final ? fmt(lGtCalc.final) : '—'}</td>
                                  <td className="px-4 py-3 text-right text-purple-700 bg-purple-50/60">{lGtCalc.finalAdj ? fmt(lGtCalc.finalAdj) : '—'}</td>
                                </tr>
                              </tbody>
                            </table>
                          </div>
                    ...
                    return (
                          ...
                          <table className="min-w-[680px] text-xs sm:text-sm">
                            ...
                            <tbody className="divide-y divide-gray-100">
                              ...
                              <tr className="hover:bg-gray-50">
                                ...
                                <td className="px-4 py-3 text-right text-purple-600 bg-purple-50/30">{ewCalc.finalAdj ? fmt(ewCalc.finalAdj) : '—'}</td>
                              </tr>
                              ...
                              <tr className="hover:bg-gray-50">
                                ...
                                <td className="px-4 py-3 text-right text-purple-600 bg-purple-50/30">{edCalc.finalAdj ? fmt(edCalc.finalAdj) : '—'}</td>
                              </tr>
                              ...
                              <tr className="bg-gray-50 font-semibold border-t-2 border-gray-300">
                                ...
                                {['full','pct','final','finalAdj'].map(f => {
                                  ...
                                  return <td key={`tot-${f}`} className={`px-4 py-3 text-right ${f==='finalAdj'?'text-purple-700 bg-purple-50/30':f==='final'?'text-green-700 bg-green-50/30':'text-blue-700 bg-blue-50/30'}`}>{sumQt ? `$${fmtInt(sumQt)}` : '—'}</td>;
                                })}
                                <td className="px-4 py-3 text-right text-blue-700 border-l-4 border-blue-300 bg-blue-50/60">{gtCalc.full ? fmt(gtCalc.full) : '—'}</td>
                                <td className="px-4 py-3 text-right text-blue-700 bg-blue-50/60">{gtCalc.disc ? fmt(gtCalc.disc) : '—'}</td>
                                <td className="px-4 py-3 text-right text-green-700 bg-green-50/60">{gtCalc.final ? fmt(gtCalc.final) : '—'}</td>
                                <td className="px-4 py-3 text-right text-purple-700 bg-purple-50/60">{gtCalc.finalAdj ? fmt(gtCalc.finalAdj) : '—'}</td>
                              </tr>
                              {/* Final Adjustment */}
                              ...
                              <tr className="bg-gray-50 font-semibold border-t-2 border-gray-300">
                                ...
                                {['full','pct','final','finalAdj'].map(f => {
                                  ...
                                  return <td key={`gt-${f}`} className={`px-4 py-3 text-right ${f==='finalAdj'?'text-purple-700 bg-purple-50/30':f==='final'?'text-green-700 bg-green-50/30':'text-blue-700 bg-blue-50/30'}`}>{sumQt ? `$${fmtInt(sumQt)}` : '—'}</td>;
                                })}
                                <td className="px-4 py-3 text-right text-blue-700 border-l-4 border-blue-300 bg-blue-50/60">{gtCalc.full ? fmt(gtCalc.full) : '—'}</td>
                                <td className="px-4 py-3 text-right text-blue-700 bg-blue-50/60">{gtCalc.disc ? fmt(gtCalc.disc) : '—'}</td>
                                <td className="px-4 py-3 text-right text-green-700 bg-green-50/60">{gtCalc.final ? fmt(gtCalc.final) : '—'}</td>
                      ...
                      {(() => {
                        ...
                        const aoCalcDisplay = (key: string, field: 'full' | 'disc' | 'final') => {
                          ...
                          const color = field === 'final' ? 'text-green-600' : 'text-blue-600';
                          return <div className={`w-full px-2 py-1.5 text-right text-sm ${color}`}>{v ? fmtAo(v) : '—'}</div>;
                        };
                        ...
                        const inpLeft = (key: string, field: string, placeholder?: string) => (
                          <textarea
                            ...
                            className="w-full px-2 py-1.5 text-left text-xs sm:text-sm border border-gray-300 rounded focus:ring-1 focus:ring-brand-navy/40 focus:border-brand-navy/40 resize-none overflow-hidden min-w-[96px]"
                        ...
                        return (
                          <div className="bg-white border border-gray-200 rounded-lg shadow-sm mt-6">
                            ...
                            <div className="overflow-x-auto">
                              <table className="min-w-[940px] text-xs sm:text-sm">
                                <thead>
                                  <tr className="bg-gray-50 border-b border-gray-200">
                                    <th className="py-2 sticky left-0 z-10 bg-gray-50" style={{ width: '24px' }}></th>
                                    <th className="px-3 py-2 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider sticky left-[24px] z-10 bg-gray-50 shadow-[inset_-1px_0_0_#e5e7eb] whitespace-nowrap" style={{ minWidth: '140px' }}>Item</th>
                                    <th className="px-2 py-2 text-right text-xs font-semibold text-gray-500 uppercase tracking-wider whitespace-nowrap" style={{ minWidth: '56px' }}>Qty</th>
                                    <th className="px-2 py-2 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider whitespace-nowrap" colSpan={2} style={{ minWidth: '200px' }}>Details</th>
                                    <th className="px-2 py-2 text-right text-xs font-semibold text-gray-500 uppercase tracking-wider whitespace-nowrap" style={{ minWidth: '80px' }}>NET €</th>
                                    <th className="px-2 py-2 text-right text-xs font-semibold text-blue-700 uppercase tracking-wider bg-blue-50/60 whitespace-nowrap" style={{ minWidth: '76px' }}>Full</th>
                                    <th className="px-2 py-2 text-right text-xs font-semibold text-blue-700 uppercase tracking-wider bg-blue-50/60 whitespace-nowrap" style={{ minWidth: '76px' }}>%</th>
                                    <th className="px-2 py-2 text-right text-xs font-semibold text-green-700 uppercase tracking-wider bg-green-50/60 whitespace-nowrap" style={{ minWidth: '76px' }}>Final</th>
                                    <th className="px-2 py-2 text-right text-xs font-semibold text-gray-500 uppercase tracking-wider" style={{ minWidth: '16px' }}></th>
                                    <th className="px-2 py-2 text-right text-xs font-semibold text-blue-700 uppercase tracking-wider border-l-4 border-blue-300 bg-blue-50/60 whitespace-nowrap" style={{ minWidth: '76px' }}>€ Full</th>
                                    <th className="px-2 py-2 text-right text-xs font-semibold text-blue-700 uppercase tracking-wider bg-blue-50/60 whitespace-nowrap" style={{ minWidth: '76px' }}>Disc</th>
                                    <th className="px-2 py-2 text-right text-xs font-semibold text-green-700 uppercase tracking-wider bg-green-50/60 whitespace-nowrap" style={{ minWidth: '76px' }}>€ Final</th>
                                ...
                                <tbody className="divide-y divide-gray-100">
                                  ...
                                  <tr className="hover:bg-gray-50">
                                    ...
                                    <td className="px-1 py-1 bg-green-50/30">{inp('windowScreens', 'final')}</td>
                                  ...
                                  <tr className="hover:bg-gray-50">
                                    ...
                                    <td className="px-1 py-1 bg-green-50/30">{inp('doorScreenSash', 'final')}</td>
                                    <td className="px-1 py-1"></td>
                                  ...
                                  <tr className="hover:bg-gray-50">
                                    ...
                                    <td className="px-1 py-1 bg-green-50/30">{inp('entryDoor', 'final')}</td>
                                    <td className="px-1 py-1"></td>
                                  ...
                                  <tr className="hover:bg-gray-50">
                                    ...
                                    <td className="px-1 py-1 bg-blue-50/30">{inp('jambExtensions', 'full')}</td>
                                    <td className="px-1 py-1 bg-blue-50/30">{inp('jambExtensions', 'pct')}</td>
                                    <td className="px-1 py-1 bg-green-50/30">{inp('jambExtensions', 'final')}</td>
                                    <td className="px-1 py-1"></td>
                                  ...
                                  <tr className="hover:bg-gray-50">
                                    ...
                                    <td className="px-1 py-1 bg-blue-50/30">{inp('magneticContact', 'full')}</td>
                                    <td className="px-1 py-1 bg-blue-50/30">{inp('magneticContact', 'pct')}</td>
                                    <td className="px-1 py-1 bg-green-50/30">{inp('magneticContact', 'final')}</td>
                                    <td className="px-1 py-1"></td>
                                  ...
                                  <tr className="hover:bg-gray-50">
                                    ...
                                    <td className="px-1 py-1 bg-blue-50/30">{inp('finalFinish', 'full')}</td>
                                    <td className="px-1 py-1 bg-blue-50/30">{inp('finalFinish', 'pct')}</td>
                                    <td className="px-1 py-1 bg-green-50/30">{inp('finalFinish', 'final')}</td>
                                    <td className="px-1 py-1"></td>
