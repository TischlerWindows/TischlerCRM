    ...
    layout.tabs.forEach((tab) => {
      tab.sections
        ...
        .forEach((section) => {
          ...
          if (isVisible && section.showInTemplate !== false && !secFx?.hidden) {
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          <div className="bg-white rounded-lg border border-gray-200">
            <div className="p-4 bg-gray-100 rounded-t-lg">
              ...
              {wizardSections[currentStep].section.description ? (
                ...
                return (
                  <div key={section.id} className="bg-white rounded-lg border border-gray-200">
                    <div className="p-4 bg-gray-100 rounded-t-lg">
                      <h3 className="text-lg font-semibold text-gray-900">{section.label}</h3>
                      {section.description ? (
                        <p className="text-xs text-gray-500 mt-1 font-normal">{section.description}</p>
                      ) : null}
                    </div>
                    <div className="p-4">
                      <div
